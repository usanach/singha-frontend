  ...
  template: `
    <section  class="onview font-['IBM_Plex_Sans_Thai']"id="project_detail" data-section="project_detail">
      <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-4 relative min-h-[900px] bg-[#F5F5F1] lg:px-0 px-5">
        <!-- Tab Buttons -->
        <div class="bg-[#33617D] bg-cover bg-center py-20 h-full lg:block hidden" :style="{ backgroundImage: 'url(/assets/image/page-shawn-wongwaen/description/info.webp)' }">
        ...
        <div class="lg:col-span-3 lg:px-20 pt-10 pb-20">
          <h2 :style="{fontFamily:fontClass()}" class="lg:text-[70px] text-[50px] text-[#013B5E] lg:text-left text-center leading-none font-normal">
            {{ title[language] }}
          </h2>
  ...
  `
                    ...
                    <div class="flex gap-5 lg:flex-row flex-col">
                      ...
                      <div class="lg:w-1/2 space-y-2 lg:block hidden relative">
                        <div class="absolute inset-0">
                          <div><p class="uppercase font-bold" :style="{fontFamily:'Gotham'}">{{ tab.title }}</p></div>
    ...
    const AmenitiesContent = {
      props: {
        ...
        amenitiesImage: {
          type: String,
          default: '/assets/image/page-shawn-panya/description/_VPX6258-Enhanced-NR.webp'
        }
      },
      template: `
        <div>
    ...
    const ServicesContent = {
      props: {
        ...
        serviceImage: {
          type: String,
          default: '/assets/image/page-shawn-panya/description/Maingate.webp'
        }
      },
      template: `
        <div>
    ...
    const fontClass = () => {
      return language.value === 'en' ? "Gotham" : "IBM Plex Sans Thai";
    };
    ...
    const projectDetailDownloadBrochure = () => {
      ...
      const brochureUrl = "/assets\/image\/page-shawn-panya\/description\/SHAWN_PANYA_INDRA_E-BROCHURE.pdf"; // Replace with your actual brochure URL
      const link = document.createElement('a');
      link.href = brochureUrl;
      link.download = "SHAWN_PANYA_INDRA_E-BROCHURE.pdf";
      link.click();
    }
    onMounted(() => {
