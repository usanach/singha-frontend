    ...
    setup() {
        ...
        const form_text = ref({
            ...
            consents: {
                ...
                th: "ท่านตกลงรับข้อมูลเกี่ยวกับผลิตภัณฑ์, บริการและข่าวสารกิจกรรมของกลุ่มธุรกิจบริษัทในเครือสิงห์ เอสเตทและพันธมิตรของบริษัทฯและรับทราบข้อกำหนด และวัตถุประสงค์การใช้ข้อมูลที่ระบุไว้ใน<a class='notice-bold underline'href='https://www.singhaestate.co.th/en/privacy-notice'target='_blank'>นโยบายความเป็นส่วนตัว</a>"
            },
        })
        ...
        const fetchProvinces = async () => {
            try {
                const response = await axios.get('/page/shawn/shawn-content-page/shawn-panya/data/thai-provinces.json');
        ...
        const fetchDistricts = async () => {
            try {
                const response = await axios.get('/page/shawn/shawn-content-page/shawn-panya/data/thai-districts.json');
        ...
        const fetchBudgets = async () => {
            try {
                const response = await axios.get('/page/shawn/shawn-content-page/shawn-panya/data/budget.json');
