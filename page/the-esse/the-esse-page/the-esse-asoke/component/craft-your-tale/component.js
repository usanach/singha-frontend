...
const CraftYourTaleComponent = defineComponent({
  ...
  setup() {
    ...
    const dataset = ref({
      title: {
        en: 'THE ESSENCE OF LUXURIOUS LIVING <br/>IS A HARMONY OF CONTRAST​',
        th: 'THE ESSENCE OF LUXURIOUS LIVING <br/>IS A HARMONY OF CONTRAST​'
      },
      image: {
        layout2: {
          l: "/assets\/image\/page-the-esse-asoke\/craft-your-tale\/S_RIN_Ratchaphruek-Sai_1-L_011.png",
          s: "/assets\/image\/page-the-esse-asoke\/craft-your-tale\/S_RIN_Ratchaphruek-Sai_1-L_011.png",
        },
        layout1: {
          l: "/assets\/image\/page-the-esse-asoke\/craft-your-tale\/ly1.png",
          s: "/assets\/image\/page-the-esse-asoke\/craft-your-tale\/ly-1-m.png",
        },
      }
    })
