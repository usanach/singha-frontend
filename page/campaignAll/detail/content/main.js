    ...
    <section class="campaign-detail-section">
        ...
        <div class="social-mobile">
            <div class="social-mobile-wrapper">
                ...
                <!-- Toggle Button -->
                <div
                    class="social-mobile-block cursor-pointer"
                ...
                <a
                    ...
                    @click.stop="handleShare('facebook')"
                >
...
// ================= SOCIAL SHARE =================
        ...
        const shareItemClass = computed(() => {
            return isSocialOpen.value
                ? 'opacity-100 translate-y-0 z-[65]'
            ...
            if (type === "facebook") {
                ...
                if (isMobileDevice) {
                    window.location.href =
                        `instagram://library?AssetPath=${encodeURIComponent(currentUrl)}`;
                } else {
