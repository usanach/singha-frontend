      ...
      <section class="onview -mt-1" id="ProjectsHighlightComponent" data-section="project_signature">
        <div class="bg-[url('/assets/image/page-condo/project/bg.png')] bg-cover bg-top">
          <div class="container lg:px-5 px-0">
            <div class="grid md:grid-cols-3 grid-cols-1 md:grid-rows-3 grid-rows-5 md:gap-8 gap-6 lg:px-4 px-0 md:py-20 py-10 md:max-h-[1024px] max-h-[2000px] lg:w-[90%] lg:ml-auto">
              <!-- Dynamic Heading -->
              <div class="p-4 text-left z-10">
                <h2 class="font-['Cinzel'] md:text-[60px] text-[40px] text-nowrap leading-none text-white">
                    <span class="text-[100px] md:text-[160px]">C</span>ondominum <br/>projects from<br/> Singha Estate
                </h2>
              </div>
  
              <!-- Dynamic Image (Small) -->
              <div class="md:col-start-2 md:col-span-2 md:row-start-1 row-start-2 row-span-2 bg-center bg-cover md:mt-0 -mt-36 drop-shadow-xl max-w-[500px] lg:ml-20 md:mx-0 mx-5 " 
              ...
              <div class="col-start-1 md:row-start-2 row-start-4 md:row-span-2 row-span-1 flex md:col-span-1">
                <div class="bg-cover bg-center lg:w-[350px] md:h-[380px] w-[270px] h-full mt-auto md:ml-auto drop-shadow-xl lg:translate-x-40" 
