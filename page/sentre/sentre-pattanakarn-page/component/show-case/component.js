...
<section class="onview font-['IBM_Plex_Sans_Thai']" data-section="360_experience">
    ...
    <div class="flex flex-col">
      <div class="container py-10">
        ...
        <div class="relative lg:hidden block my-5 z-10" ref="mobileSelectRef">
          <button
            type="button"
            class="project-detail-button-listM bg-[#707070] bg-cover bg-center px-5 text-center w-full lg:py-3 py-2 text-white lg:text-[24px] text-[18px] relative"
  ...
  setup() {
    ...
    const scenes = ref([
      ...
      {
        id: 'bedRoom',
        label: { en: 'BedRoom', th: 'BedRoom' },
        url: 'https://my.matterport.com/show/?m=NoWXAMAECEb',
      },
      {
        id: 'dinningRoom',
        label: { en: 'Dining Room', th: 'Dining Room' },
        url: 'https://my.matterport.com/show/?m=NoWXAMAECEb',
      },
    ]);
