...
const FormRegisterComponent = defineComponent({
        ...
        <section class="form-register onview font-['IBM_Plex_Sans_Thai']" id="register" data-section="lead_register">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-75 z-[9999]" :class="[isSuccess ? 'block':'hidden']">
                <div class="p-5 rounded-lg h-full flex">
                    <div class="m-auto">
                        <img src="/assets\/image\/page-the-esse-36\/register\/the-esse-36_thnkyou-bn-popup.jpg" class="lg:block hidden" />
                        <img src="/assets\/image\/page-the-esse-36\/register\/the-esse-36_thnkyou-bn-popup-m.jpg" class="lg:hidden" />
                    </div>
                </div>
    ...
    setup() {
        ...
        const BgImage = ref("/assets\/image\/page-the-esse-complex\/register\/ESSE-FirstSet-2BR-01.png")
        const mobileBgImage = ref("/assets\/image\/page-the-esse-complex\/register\/shutterstock_2559746425.jpg")
        const regBgImage = ref("/assets\/image\/page-the-esse-complex\/register\/shutterstock_2559746425.jpg")
        const form_text = ref({
            title: {
        ...
        const fetchBudgets = async () => {
            try {
                const response = await axios.get('/page\/the-esse\/the-esse-page\/the-esse-36\/data\/budget.json');
