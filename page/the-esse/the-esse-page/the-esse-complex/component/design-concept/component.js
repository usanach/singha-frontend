...
const DesignConceptComponent = defineComponent({
    ...
    setup() {
        ...
        const description = ref({
            en: `Asoke District's significant business growth and bold urban planning have made it the premier address for city living. Here, residents enjoy seamless access to lifestyle, leisure, work, and shopping. The upcoming Makkasan Complex promises to transform and elevate the area, creating Bangkok’s own version of Central Park with art museums and innovative retail destinations. Investment value in Singha Complex is poised to appreciate for generations, offering lasting prosperity to its residents.`,
