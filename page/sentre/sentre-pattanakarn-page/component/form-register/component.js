...
const FormRegisterComponent = defineComponent({
        ...
        <section class="form-register onview font-['IBM_Plex_Sans_Thai']" id="register" data-section="lead_register">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-75 z-[9999]" :class="[isSuccess ? 'block':'hidden']">
                <div class="p-5 rounded-lg h-full flex">
                    <div class="m-auto">
                        <img aria-hidden="true" src="/assets\/image\/page-sentre\/register\/sentre_thnkyou_bn_popup.jpg" class="lg:block hidden" />
                        <img aria-hidden="true" src="/assets\/image\/page-sentre\/register\/sentre_thnkyou_bn_popup_m.jpg" class="lg:hidden" />
                    </div>
                </div>
    ...
    setup() {
        ...
        const BgImage = ref('/assets/image/page-sentre/register/DS1_V2-NEW.png')
        const mobileBgImage = ref('/assets/image/page-sentre/register/DS1_V2-NEW.png')
        const regBgImage = ref('/assets/image/page-sentre/register/bg.png')
        ...
        const validateForm = async () => {
            ...
            if (Object.values(errors.value).every(error => !error)) {
                ...
                try {
                    ...
                    object.token = token;
                    await axios.post(`https://residential2.singhaestate.co.th/th/lead/sentre-pattanakarn/droplead.php`, object);
