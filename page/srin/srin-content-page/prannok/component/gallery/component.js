const GalleryComponent = defineComponent({
    ...
    template: `
        <section id="gallery" data-section="gallery" class="gallery-component bg-[url('/assets/image/page-smyth-kaset/gallery/bg.png')] bg-cover bg-center lg:pb-20 relative">
