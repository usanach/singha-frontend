const GalleryComponent = defineComponent({
    ...
    setup() {
        const galleries = ref(
            [
                { cate: 'exterior', type: 'image', url: '/assets/image/page-smyth-ramintra/gallery/2.png' },
                { cate: 'interior', type: 'image', url: '/assets/image/page-smyth-ramintra/gallery/4.png' },
                { cate: 'interior', type: 'image', url: '/assets/image/page-smyth-ramintra/gallery/5.png' },
                { cate: 'interior', type: 'image', url: '/assets/image/page-smyth-ramintra/gallery/6.png' },
