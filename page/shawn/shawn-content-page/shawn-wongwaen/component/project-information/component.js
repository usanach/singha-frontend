const ProjectInformationComponent = defineComponent({
  ...
  setup() {
    ...
    const brochureUrl = ref("/assets\/image\/page-shawn-wongwaen\/description\/SHAWN_WONG_WONGWAEN-CHATUCHOT_E-Brochure.pdf");
    const title = ref({
  ...
  `
    ...
    const AmenitiesContent = {
      props: {
        ...
        amenitiesImage: {
          type: String,
          default: '/assets/image/page-shawn-wongwaen/description/KANTxSHAWN-WONGWAEN-CHATUCHOT67.webp'
        }
      },
      template: `
        <div>
    ...
    const ServicesContent = {
      props: {
        ...
        serviceImage: {
          type: String,
          default: '/assets/image/page-shawn-wongwaen/gallery/Exterior/002.webp'
        }
      },
      template: `
        <div>
