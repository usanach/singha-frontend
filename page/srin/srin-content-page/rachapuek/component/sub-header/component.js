...
const SubHeaderComponent = defineComponent({
    ...
    <nav class="sub-header top-[63px] w-full absolute left-0 z-10 border border-b-1 border-l-0 border-r-0 border-t-0 border-white/50 lg:block hidden">
        <div class="container mx-auto py-3 relative">
            <div class="flex">
                <div class="my-auto">
                    <img src="/assets/image/page-srin-rachapuek/banner/rachapuek-logo.png" alt="" class="w-[100px] logo">
                </div>
                ...
                ScrollTrigger.create({
                    ...
                    onUpdate: (self) => {
                        if (self.progress > 0) {
                            ...
                            document.querySelector('.sub-header .logo').src = '/assets/image/page-srin-rachapuek/banner/rachapuek-logo-color.png';
                            ...
                            document.querySelector('.sub-header .logo').src='/assets/image/page-srin-rachapuek/banner/rachapuek-logo.png';
