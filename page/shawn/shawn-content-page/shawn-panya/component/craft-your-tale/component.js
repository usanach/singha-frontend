...
const CraftYourTaleComponent = defineComponent({
                ...
                <div class="w-full h-full bg-[#00000030]">
                    <div class="absolute top-0 left-0 h-full w-full flex">
                        <div class="flex flex-col w-4/5 m-auto mb-[10%] mt-[11rem] md:mt-[12rem]  relative">
                            ...
                            <div v-if="isVideoVisible" ref="videoContainer" class="relative w-full h-[600px] mx-auto bg-black z-20">
                                <iframe id="player"
                                    class="w-full h-full" 
    ...
    setup() {
        ...
        let iframeSrc = ref("https://www.youtube.com/embed/3w1UbJe1wXc?autoplay=1");
