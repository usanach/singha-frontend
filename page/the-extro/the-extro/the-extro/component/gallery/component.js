const GalleryComponent = defineComponent({
    ...
    template: `
        <section id="gallery" data-section="gallery" class="gallery-component onview bg-[#BC6F2D] bg-cover bg-center relative">
            <div class="pt-10 px-0">
                <h2 class="font-['Gotham'] text-[40px] font-bold text-center text-white uppercase" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                    Gallery
                </h2>
    ...
    setup() {
        ...
        const galleriesDetail = ref({
            all: [
                [
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', id: 1 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-3', id: 2 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-4', id: 3 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/4.png', class: 'row-span-6', id: 4 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-3', id: 5 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/6.png', class: 'row-span-2', id: 6 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', id: 7 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-3', id: 8 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-4', id: 9 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/4.png', class: 'row-span-6', id: 10 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-3', id: 11 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/6.png', class: 'row-span-2', id: 12 },
                ]
            ],
            exterior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-6', id: 1 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-3', id: 2 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-4', id: 3 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-6', id: 4 },
            ]
            ],
            interior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', id: 1 },
            ...
            facilities: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', detail: 1 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-3', detail: 2 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-4', detail: 3 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/4.png', class: 'row-span-6', detail: 4 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-3', detail: 5 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/6.png', class: 'row-span-2', detail: 6 },
            ]
            ],
            vdo: [[
        ...
        const galleries = ref({
            ...
            exterior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-6', detail: 1 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-3', detail: 2 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-4', detail: 3 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-6', detail: 4 },
            ]
            ],
            interior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', detail: 1 },
        ...
        const galleriesM = ref({
            all: [
                [
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', detail: 1 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-3', detail: 2 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/3.png', class: 'row-span-3', detail: 3 },
                ],
                [

                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/4.png', class: 'row-span-6', detail: 4 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-3', detail: 5 },
                    { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/6.png', class: 'row-span-3', detail: 6 },
                ]
            ],
            exterior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/2.png', class: 'row-span-6', detail: 1 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-3', detail: 2 },
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/5.png', class: 'row-span-3', detail: 3 },
            ]
            ],
            interior: [[
                { type: 'image', url: '/assets/image/page-the-extro/the-extro/gallery/1.png', class: 'row-span-6', detail: 1 },
