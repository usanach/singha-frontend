const GalleryComponent = defineComponent({
    ...
    template: `
        <section id="gallery" data-section="gallery" class="gallery-component onview bg-[#B29C85] bg-cover bg-center relative font-['IBM_Plex_Sans_Thai']">
            <div class="pt-10 px-0">
                <h2 class="font-normal text-[35px] text-center text-white uppercase" :style="{fontFamily: language === 'th' ? 'DB OnUma' : 'The Seasons',fontSize:language === 'th' ? '40px' : ''}" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                   {{title[language]}}
                </h2>
    ...
    setup() {
        const galleries = ref([
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/exterior/s_1122439.jpg' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/exterior/s_2063316.jpg' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/exterior/s_2924572.jpg' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/exterior/s_4396149.jpg' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN207.webp' },

            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN15.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN61.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN62.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN115.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN132.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN178.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN179.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/interior/KANT%20x%20SIRANINN197.webp' },

            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/facilities/KANT%20x%20SIRANINN11.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/facilities/KANT%20x%20SIRANINN92.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/facilities/KANT%20x%20SIRANINN154.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/page-siraninn/gallery/minimize/facilities/KANT%20x%20SIRANINN206.webp' },
