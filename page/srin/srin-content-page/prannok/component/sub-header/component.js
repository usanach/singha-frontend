const SubHeaderComponent = defineComponent({
  ...
  setup() {
    const language = ref('th'); // Default language
      const logo = ref('/assets/image/page-srin-prannok/banner/prannok-logo.webp');
      ...
      if (subHeader.value && logoRef.value) {
        ...
        if (progress > 0) {
          ...
          linkTexts.forEach(el => el.classList.add('!text-black'));
            logoRef.value.src ='/assets/image/page-srin-prannok/banner/prannok-logo-color.webp';
          ...
          linkTexts.forEach(el => el.classList.remove('!text-black'));
            logoRef.value.src =  '/assets/image/page-srin-prannok/banner/prannok-logo.webp';
