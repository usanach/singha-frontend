        ...
        <section class="form-register onview" id="register" data-section="lead_register">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-75 z-[9999]" :class="[isSuccess ? 'block':'hidden']">
                <div class="p-5 rounded-lg h-full flex">
                    <div class="m-auto">
                        <img aria-hidden="true" src="/assets/image/page-shawn-panya/register/Thankyou-Popup-desktop.webp" class="lg:block hidden" />
                        <img aria-hidden="true" src="/assets/image/page-shawn-panya/register/Thankyou-Popup-mobile.webp" class="lg:hidden" />
                    </div>
                </div>
