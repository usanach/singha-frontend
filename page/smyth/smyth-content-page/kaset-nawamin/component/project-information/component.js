    ...
    setup() {
        ...
        const ProjectDetailsContent = {
            ...
            data() {
                return {
                    dataset: [{
                            // Project basic details (from detail[0])
                            projectArea: {
                                th: "ประมาณ 5 ไร่​",
                                en: "Approximately 5 rais​",
                            },
                            type: {
                                th: "บ้านเดี่ยว 3 ชั้น 2 รูปแบบ​\nทุกแปลงเป็นบ้านหลังมุม​​",
                                en: "3-Storey Detached House – two designs​\nEvery residence is the corner plot​",
                            },
                            unit: {
                                th: "10 หลัง​​",
                                en: "10 units",
            ...
            methods: {
                formatKey(key) {
                    const mapping = {
                        projectArea: this.language === 'th' ? "ขนาดโครงการ" : "Project Land Area",
                        type: this.language === 'th' ? "ประเภทโครงการ" : "Residential Type",
        ...
        <div class="space-y-5 mt-5">
          ...
          <div class="grid grid-cols-2 gap-5 lg:w-1/2 ">
            <template v-for="(value, key) in dataset[0]" :key="key">
              <p class="font-normal whitespace-pre-line">{{ formatKey(key) }} :</p>
          ...
          <div v-for="(item, index) in dataset.slice(1)" :key="index" class="pt-5">
            ...
            <div class="lg:w-1/2 mt-5">
              <template v-for="(rt, i) in item.data" :key="i">
                <div class="grid  gap-5" :class="rt.size?'grid-cols-2':'grid-cols-1'">
  ...
  `
        ...
        const PlanContent2 = {
            ...
            data() {
                return {
                    tabs: [
                        // วาง 2 แท็บนี้ต่อท้ายใน array tabs เดิมของคุณ
                        {
                            id: 'residenceI',
                        ...
                        },
                        {
                            ...
                            specs: [{
                                ...
                                },
                                {
                                    type: 'text',
                                    icon: '',
                                    alt: 'สระว่ายน้ำระบบจากุซซี่ พร้อมระเบียง 3.70 x 7.2 เมตร ​',
                                    text: {
