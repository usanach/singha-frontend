    ...
    <section id="lifestyle" data-section="s_lifestyle"
        ...
        <div class="container relative my-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
            <div class="flex flex-col gap-10">
                <div>
                    <h2 class="text-[40px] uppercase font-['Gotham'] font-normal text-center text-[#5D4F48]">
                        S LIFESTYLE
                    </h2>
                    <p class="text-center text-[#5D4F48] text-[14px]">
                ...
                <div class="flex gap-5 lg:flex-row flex-col lg:mt-5 mt-2">
                    <div class="lg:w-2/6 w-full space-y-3">
                        <p class="text-[24px] font-['Gotham'] font-medium uppercase text-[#5D4F48]">
                            Distinctive Location
                        </p>
                        <p class="text-[#5D4F48] text-[14px]">
                    ...
                    <div class="flex lg:gap-20 mx-auto flex-wrap">
                        <div class="lg:w-1/6 lg:mt-0 mt-5 w-1/2" v-for="(item,distinctive_location_meters_id) in datasets.distinctive_location_meters" :key="distinctive_location_meters_id">
                            <p class="font-thin text-[80px] text-[#5D4F48] leading-none text-center">
                               {{item.text[language]}}
                            </p>
                            <p class="text-[#5D4F48] text-center leading-none">
                                {{item.unit[language]}}
                            </p>
                            <p class="text-[#5D4F48] text-center">
                ...
                <div class="flex lg:gap-10 gap-2 mt-5 lg:flex-row flex-col">
                    <div class="space-y-3 lg:w-1/4 w-full pb-5">
                        <div class="h-[40px]">
                            <img src="/assets/image/page-shawn-wongwaen/life/sedan_2736918.png" alt="" >
                        </div>
                        <div>
                            <p class="text-[16px] font-medium uppercase text-[#5D4F48]" :class="[fonts]">
                                {{datasets.transportations.title[language]}}
                            </p>
                        </div>
                        <div>
                            <ul> 
                                <li class="group flex justify-between text-[#5D4F48] my-2" v-for="(item, transportationsId) in datasets.transportations.item" :key="transportationsId" >
                    ...
                    <div class="space-y-3  lg:w-1/4 w-full pb-5 lg:block" :class="{ hidden: !expand }">
                        <div class="h-[40px]">
                            <img src="/assets/image/page-shawn-wongwaen/life/medic.png" alt="" class="w-[33px]">
                        </div>
                        <div>
                            <p class="text-[16px] font-medium uppercase text-[#5D4F48]" :class="[fonts]">
                        ...
                        <div>
                            <ul>
                                <li class="group flex justify-between text-[#5D4F48] my-2" v-for="(item, hospitalsId) in datasets.hospitals.item" :key="hospitalsId" >
                                    <div class="lg:max-w-[180px] text-[14px] group-hover:text-nowrap truncate group-hover:whitespace-normal group-hover:overflow-visible group-hover:break-words" v-html="item.name[language]"></div>
                                    <div class="text-right text-[14px] group-hover:opacity-25 transition-all text-nowrap">
                                        {{item.detail[language]}}
                                    </div>
                    ...
                    <div class="space-y-3  lg:w-1/4 w-full pb-5 lg:block" :class="{ hidden: !expand }">
                        <div class="h-[40px]">
                            <img src="/assets/image/page-shawn-wongwaen/life/shopping-cart_833314.png" alt="" class="w-[33px]">
                        </div>
                        <div>
                            <p class="text-[16px] font-medium uppercase text-[#5D4F48]" :class="[fonts]">
                        ...
                        <div>
                            <ul>
                                <li class="group flex justify-between text-[#5D4F48] my-2" v-for="(item,surrounding_amenitiesId) in datasets.surrounding_amenities.item" :key="surrounding_amenitiesId" >
                                    <div class="lg:max-w-[180px] text-[14px] group-hover:text-nowrap truncate group-hover:whitespace-normal group-hover:overflow-visible group-hover:break-words" v-html="item.name[language]"></div>
                                    <div class="text-right text-[14px] group-hover:opacity-25 transition-all text-nowrap">
                                        {{item.detail[language]}}
                                    </div>
                    ...
                    <div class="space-y-3  lg:w-1/4 w-full pb-5 lg:block" :class="{ hidden: !expand }">
                        <div class="h-[40px]">
                            <img src="/assets/image/page-shawn-wongwaen/life/education_13807278.png">
                        </div>
                        <div>
                            <p class="text-[16px] font-medium uppercase text-[#5D4F48]" :class="[fonts]">
                        ...
                        <div>
                            <ul>
                                <li class="group flex justify-between text-[#5D4F48] my-2" v-for="(item,educationsId) in datasets.educations.item" :key="educationsId" >
                                    <div class="lg:max-w-[180px] text-[14px] group-hover:text-nowrap truncate group-hover:whitespace-normal group-hover:overflow-visible group-hover:break-words" v-html="item.name[language]"></div>
                                    <div class="text-right text-[14px] group-hover:opacity-25 transition-all text-nowrap">
                                        {{item.detail[language]}}
                                    </div>
