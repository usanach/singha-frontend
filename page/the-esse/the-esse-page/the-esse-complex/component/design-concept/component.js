...
const DesignConceptComponent = defineComponent({
    ...
    setup() {
        ...
        const description = ref({
            ...
            th: 'อโศก เป็น ทำเลศูนย์กลางธุรกิจที่มั่นคงมีสิ่งแวดล้อมเพื่อการทำงานและการใช้ชีวิตครบครัน และเติบโตต่อเนื่องด้วยนโยบายพัฒนาพื้นที่เชิงรุก ใกล้โครงการมักกะสันคอมเพล็กซ์ แลนด์มาร์กที่กำลังจะพลิกโฉมกรุงเทพอีกครั้งด้วย เซ็นทรัลพาร์คเมืองกรุงแห่งใหม่ พิพิธภัณฑ์ศิลปะ สถานที่จัดแสดงงาน และแหล่งรีเทลทันสมัยขนาดใหญ่ ยกระดับให้ The ESSE Singha Complex ก้าวสู่โครงการที่คุ้มค่า มูลค่าการลงทุนที่จะเพิ่มขึ้นจากรุ่นสู่รุ่น มอบความมั่งคั่งที่ยั่งยืนสำหรับผู้ที่เลือกที่นี่เป็นบ้าน​'
        })
