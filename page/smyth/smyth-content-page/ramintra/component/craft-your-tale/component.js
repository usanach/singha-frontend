    ...
    <section class="craft-your-tale-component relative overflow-hidden">
        <div class="lg:block hidden">
            <div id="layout-2" class="layout-2 absolute inset-0 flex items-center justify-center z-10">
                <div>
                    <img src="/assets/image/page-smyth-ramintra/craft-yours-tale/img.png" alt="">
                    <div class="absolute top-0 left-0 h-full w-full flex">
                        <div class="flex flex-col m-auto">
                            <div>
                                <img src="/assets/image/page-smyth-ramintra/craft-yours-tale/smyth_logo.png" alt="" class="max-w-[300px]">
                            </div>
                            <div class="mt-3">
            ...
            <div id="layout-1" class="layout-1 relative inset-0 flex items-center justify-center z-20">
                <img src="/assets/image/page-smyth-ramintra/craft-yours-tale/sm.png" alt="">
            </div>
        </div>

        <div class="lg:hidden block">
            <div id="layout-2-m" class="layout-2 absolute inset-0 flex items-center justify-center z-10" class="w-full bg-[url('/assets/image/page-smyth-ramintra/craft-yours-tale/img-m.png')] bg-cover bg-center">
            ...
            <!-- Layout 1 (Foreground Layer) -->
            <div id="layout-1-m" class="layout-1 relative inset-0 flex items-center justify-center z-20">
                <img src="/assets/image/page-smyth-ramintra/craft-yours-tale/sm-m.png" alt="" class="w-full">
            </div>
        </div>
    </section>`,
            ...
            nextTick(() => {
                ...
                gsap.fromTo("#layout-2",
                    { opacity: 1 },
                    {
                        ...
                        scrollTrigger: {
                            trigger: "#layout-2",
                            start: "top top",  // Starts when the top of layout 2 reaches the center of the viewport
                            end: "+=500",            // Animation duration in scroll distance
                            scrub: 2,                // Smooth scrubbing
                            pin: true,               // Pin the element during the animation
                            pinSpacing: true         // Add spacing for pinning
