  ...
  template: `
    <section  class="onview font-['IBM_Plex_Sans_Thai']" :src="{fontClass}" id="project_detail" data-section="project_detail">
      <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-4 relative min-h-[900px] bg-[#F5F5F1] lg:px-0 px-5">
        <!-- Tab Buttons -->
        <div class="bg-[#33617D] bg-cover bg-center py-20 h-full lg:block hidden" :style="{ backgroundImage: 'url(/assets/image/page-srin-prannok/description/info.webp)' }">
        ...
        <div class="lg:col-span-3 lg:px-20 pt-10 pb-20">
          <h2 :style="{fontFamily:'DB OnUma'}" class="lg:text-[70px] text-[50px] text-[#013B5E] lg:text-left text-center leading-none font-normal">
            {{ title[language] }}
          </h2>
