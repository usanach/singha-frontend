        ...
        <section class="form-register onview font-['IBM_Plex_Sans_Thai']" id="register" data-section="lead_register">
            <div class="relative lg:h-[900px]">
                <div class="flex lg:flex-row flex-col h-full w-full">
                    <div
                        class="w-full lg:h-full h-[500px] bg-[url('/assets/image/page-smyth-kaset/register/Desktop-Kaset.webp')] bg-cover bg-center">
                    </div>
                    <div
                        class="w-full h-full h-full bg-[url('/assets/image/page-smyth-kaset/register/bg.webp')] bg-cover bg-center flex">
