...
const HeaderComponent = defineComponent({
    ...
    <div id="header" class="w-full" data-submenu="property collection" data-sublink="/collection.html">
        <div class="wrapper" v-html="template"></div>
    </div>`,
...
function toggleSubmenu() {
    ...
    document.querySelector('#header .modal-header').classList.add('hidden');
    document.querySelector('#header .modal-sub-header').classList.remove('hidden');
    toggleHeaderSubmenu();
...
function toggleMenuList() {
    document.querySelector('body').addEventListener('wheel', preventDefault, { passive: false });
    document.querySelector('#header .wrapper').classList.add('wrapped');
    document.querySelector('#header .modal-header').classList.remove('hidden');
    document.querySelector('#header .modal-sub-header').classList.add('hidden');
