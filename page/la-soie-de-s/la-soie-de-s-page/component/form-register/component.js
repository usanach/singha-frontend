...
const FormRegisterComponent = defineComponent({
    ...
    template: `
        <section class="form-register onview font-['IBM_Plex_Sans_Thai']" id="register" data-section="lead_register" :style="{fontFamily:language=='th'?'':'Cormorant Garamond'}">
                            ...
                            <div class="m-auto lg:max-w-[70%] px-5 py-10">
                                <form @submit.prevent="validateForm" data-aos="fade-in" data-aos-duration="1000" data-aos-easing="linear">
                                    <div class="flex flex-col gap-10">
                                        <div>
                                            <h2 class=" text-center text-[35px] font-normal">
                                            ...
                                            <div class="flex flex-col gap-10">
                                                <div class="flex gap-8 lg:flex-row flex-col">
                                                    <div class="lg:w-1/2 w-full">
                                                        <input type="text" name="fname" v-model="form.fname"
                                                            class="bg-transparent border border-b-1 border-l-0 border-t-0 border-r-0 w-full border-black placeholder:text-black"
                                                ...
                                                <div class="flex gap-8 lg:flex-row flex-col">
                                                    <div class="lg:w-1/2 w-full relative">
                                                        <label for="province"
                                                            class=" w-full absolute top-0 left-0 w-full h-full cursor-pointer ">{{selectedProvince == null ?form_text.province[language] : ''}}</label>
                                                    ...
                                                    <div class="lg:w-1/2 w-full relative">
                                                        <label for="district"
                                                            class=" w-full absolute top-0 left-0 w-full h-full cursor-pointer">{{selectedDistrict == null ? form_text.district[language] : ''}}</label>
                                                ...
                                                <div class="flex gap-8 lg:flex-row flex-col">
                                                    <div class="w-full">
                                                        <div class="relative">
                                                            <label for="budget"
                                                                class=" w-full absolute top-0 left-0 w-full h-full cursor-pointer">{{selectedBudget !== null ? '' :  form_text.budgets[language]}}</label>
                                                    ...
                                                    <div class="w-full">
                                                        <div class="flex items-center space-x-2">
                                                            <div class="relative mb-auto">
                                                                ...
                                                                <label for="custom-checkbox"
                                                                    class="cursor-pointer  hidden peer-checked:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                                                            ...
                                                            <!-- Label Text -->
                                                            <span class="" v-html="form_text.consents[language]"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mx-auto">
                                                    <button type="submit"
                                                        id="btnSubmit"
                                                        class="border border-1 border-black px-16 py-2 hover:bg-white/30 lg:w-auto w-full">
                                                        <div class="loaded ">
                                                            <p class="text-nowrap font-normal ">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-75 z-[9999]" :class="[isSuccess ? 'block':'hidden']">
                <div class="p-5 rounded-lg h-full flex">
                    <div class="m-auto">
                        <img aria-hidden="true" src="/assets\/image\/page-la-soie-de-s\/register\/sentre_thnkyou_bn-popup.jpg" class="lg:block hidden" />
                        <img aria-hidden="true" src="/assets\/image\/page-la-soie-de-s\/register\/lasoie_thnkyou_bn-popup-m.jpg" class="lg:hidden" />
                    </div>
                </div>
        ...
        const validateForm = async () => {
            ...
            if (Object.values(errors.value).every(error => !error)) {
                ...
                try {
                    ...
                    object.token = token;
                    await axios.post(`https://residential2.singhaestate.co.th/th/lead/lasoiedes-sukhumvit43/droplead.php`, object);
