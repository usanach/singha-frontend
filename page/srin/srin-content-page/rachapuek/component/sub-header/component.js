const SubHeaderComponent = defineComponent({
      ...
      <div class="lg:block hidden">
        ...
        <nav ref="subHeader" class="sub-header top-[65px] w-full absolute left-0 z-[99] border-b border-white/50 lg:block hidden">
          <div class="container mx-auto py-3 relative flex items-center">
            <div class="my-auto">
              <img aria-hidden="true" ref="logoRef" :src="logo" alt="logo" class="w-[100px] logo">
            </div>
  ...
  setup() {
    ...
    const logo = ref('/assets/image/page-srin-rachapuek/banner/rachapuek-logo.webp');
    ...
    const updateSubHeaderStyle = (progress) => {
      if (subHeader.value && logoRef.value) {
        ...
        if (progress > 0) {
          ...
          logoRef.value.src = '/assets/image/page-srin-rachapuek/banner/rachapuek-logo-color.webp';
          ...
          logoRef.value.src = '/assets/image/page-srin-rachapuek/banner/rachapuek-logo.webp';
