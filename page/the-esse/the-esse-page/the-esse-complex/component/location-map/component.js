const LocationComponent = defineComponent({
    ...
    setup() {
        ...
        const imageUrl = '/assets\/image\/page-the-esse-complex\/location\/s_2289199.jpg';
        const googleUrl = "https://maps.app.goo.gl/ZCEZVWBVwiT9Uq737";
        ...
        const downloadMap = () => {
            ...
            link.href = imageUrl;
            link.download = 'the_esse_complex.png';
            link.click();
        };
