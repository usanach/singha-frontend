const LifeStyleComponent = defineComponent({
  ...
  template: `
      <section id="s_lifestyle" data-section="s_lifestyle"
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-black/30 bg-[position:center_80dvh] bg-no-repeat bg-cover" :style="{backgroundImage:'url(/assets\/image\/santiburi-page\/bg-lifestyle.png)'}"></div>
