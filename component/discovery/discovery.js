                    ...
                    data-aos="fade-up" data-aos-duration="800" data-aos-easing="linear" data-aos-delay="${index * 100}">
                        ...
                        <div class="flex w-full relative -mt-10 bg-white/50 max-h-[95px] overflow-hidden">
                            ...
                            <div class="flex flex-col p-5 lg:py-2 py-2 w-full relative">
                                <div
                                    class="${data.data.new == true ? 'hidden lg:block' : 'hidden'} lg:text-[14px] text-[12px] bg-[url('./../assets/icon/badge.svg')] w-auto top-0 lg:right-0 lg:mt-2 lg:left-auto left-0 lg:mr-2 absolute capitalize bg-no-repeat bg-cover px-5 py-1 text-white font-bold text-center">
                                    New Project</div>
