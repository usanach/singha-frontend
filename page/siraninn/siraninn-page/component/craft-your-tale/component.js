      ...
      >
        <div class="w-full h-full">
          <div class="absolute top-0 left-0 h-full w-full flex">
            <div class="flex flex-col mx-auto mb-auto mt-[20dvh]">
              <div class="mt-3">
                <p class="font-light text-[35px] text-center cyt-desc"
  ...
  `,
    ...
    setup() {
        ...
        const dataset = ref({
            ...
            image: {
                layout2: {
                    l: "/assets\/image\/page-siraninn\/craft-yours-tale\/SIRANINN_RESIDENCES_FACADE_L_P.jpg",
                    s: "/assets\/image\/page-siraninn\/craft-yours-tale\/SIRANINN_RESIDENCES_FACADE_L_P.jpg",
                },
                layout1: {
