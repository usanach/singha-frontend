        ...
        <div class="bg-[url('/assets/image/page-house/house-project-bg.png')] bg-cover bg-bottom">
          <div class="container lg:px-5 px-0">
            <div class="grid md:grid-cols-3 grid-cols-1 md:grid-rows-3 grid-rows-5 md:gap-8 gap-6 lg:px-4 px-0 md:py-20 py-10 md:max-h-[930px] max-h-[2000px]">
              ...
              <!-- Dynamic Image (Small) -->
              <div class="col-start-2 col-start-1 col-span-2 md:row-start-1 row-start-2 row-span-2 bg-center bg-cover md:mt-0 -mt-36" 
                   :style="{ backgroundImage: 'url(' + data.images.s + ')' }"></div>
  
              <!-- Dynamic Image (Large) -->
              <div class="col-start-1 md:row-start-2 row-start-4 md:row-span-2 row-span-1 flex md:col-span-1 col-span-3">
                <div class="bg-cover bg-center lg:w-[350px] md:h-[380px] w-[270px] h-full mt-auto md:ml-auto" 
                     :style="{ backgroundImage: 'url(' + data.images.l + ')' }"></div>
              </div>
  
              <!-- Dynamic Paragraph -->
              <div class="col-start-2 col-span-2 md:row-start-3 row-start-5">
