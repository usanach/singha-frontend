const GalleryComponent = defineComponent({
    ...
    template: `
        <section id="gallery" data-section="gallery" class="gallery-component onview bg-cover bg-center relative font-['IBM_Plex_Sans_Thai']" :style="{backgroundImage:'url(/assets/image/santiburi-page/gallery/bg.png)'}">
            <div class="pt-10 px-0">
                ...
                <!-- Category Buttons -->
                <div class="gallery-controls flex gap-4 mb-6 lg:justify-center justify-evenly lg:px-0 px-5 lg:overflow-auto overflow-x-scroll w-full" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                    <button
    ...
    setup() {
        const galleries = ref([
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI16.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI60.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI80.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI99.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI107.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI205.webp' },
            { cate: 'exterior', title: { en: 'exterior', th: 'ภาพตกแต่งภายนอก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/exterior/KANT%20x%20SANTIBURI207.webp' },

            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI1.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI14.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI23.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI29.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI37.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI42.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI45.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI70.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI154.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI196.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI213.webp' },
            { cate: 'interior', title: { en: 'interior', th: 'ภาพตกแต่งภายใน' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/interior/KANT%20x%20SANTIBURI219.webp' },

            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/facilities/KANT%20x%20SANTIBURI12.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/facilities/KANT%20x%20SANTIBURI13.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/facilities/KANT%20x%20SANTIBURI73.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/facilities/KANT%20x%20SANTIBURI159.webp' },
            { cate: 'facilities', title: { en: 'facilities', th: 'สิ่งอำนวยความสะดวก' }, type: 'image', url: '/assets/image/santiburi-page/gallery/minimize/facilities/KANT%20x%20SANTIBURI190.webp' },
