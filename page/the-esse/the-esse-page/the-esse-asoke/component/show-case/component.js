const ShowCaseComponent = defineComponent({
  ...
  template: `
<section class="onview font-['IBM_Plex_Sans_Thai']" data-section="360_experience" :style="{backgroundColor:'#182A44'}">
  <div class="relative">
            ...
            <div class="absolute left-0 top-0 w-1/5 bg-black/40 h-full lg:flex hidden z-20">
              <div class="m-auto w-full px-4">
                <div class="flex justify-center">
                  <img src="/assets\/image\/page-the-esse-asoke\/logo.svg" alt="logo" />
                </div>
