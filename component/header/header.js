          ...
          <div class="my-auto flex gap-3  relative ml-auto">
            <div>
                <button type="button" class="lg:flex hidden h-full" @click="toggleSubModal">
                    <div class="my-auto">
                        <p class="uppercase text-white leading-tight text-[12px]" :class="singhaFonts">
            ...
            <div class="relative px-2" ref="langRef">
                <button type="button" class="lg:flex hidden h-full" @click="toggleLanguage">
                    <div class="my-auto flex gap-2">
                        <svg class="w-[15px] my-auto" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="uppercase text-white text-[12px] my-auto">{{language}}</p>
                        <svg class="my-auto transition-all duration-500 w-[15px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
