            ...
            try {
                const swipeData = [{
                    ...
                    description: {
                        ...
                        th: "คอนโดใจกลาง พญาไท-รางน้ำ ติดสวนสันติภาพ สวนสาธารณะพื้นที่กว่า 20 ไร่ <br/>เริ่มต้น 5.99 ลบ.​",
                    },
                    image: {
                ...
                const templateResponse = await axios.get('/page/the-extro/the-extro/the-extro/component/banner/template.html');
