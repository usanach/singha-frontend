...
const DesignConceptComponent = defineComponent({
    ...
    setup() {
        ...
        const description = ref({
            en: 'Immense business growth and bold public planning have established the Asoke District as the foremost area for the urban lifestyle where the needs of living, playing, working, and shopping are all just a stone’s throw away. The upcoming Makkasan Complex will transform and uplift the area by creating Bangkok’s own flavor of Central Park, where it will also host art museums and other innovative retail spaces. Investment value at Singha Complex will transcend generations.',
            th: 'Immense business growth and bold public planning have established the Asoke District as the foremost area for the urban lifestyle where the needs of living, playing, working, and shopping are all just a stone’s throw away. The upcoming Makkasan Complex will transform and uplift the area by creating Bangkok’s own flavor of Central Park, where it will also host art museums and other innovative retail spaces. Investment value at Singha Complex will transcend generations.'
        })
