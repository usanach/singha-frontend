      ...
      <div class="bg [background-image:radial-gradient(circle,_rgba(46,80,128,1)_0%,_rgba(26,47,78,1)_100%)] py-2 relative z-50 flex transition-all">
        <div class="absolute inset-0  flex items-center justify-center">
            <div class="text-center">
                <p class="uppercase text-white text-[15px]">Residential</p>
            </div>
        </div>
        <div class="flex container mx-auto justify-between relative my-auto">
          <div>
            <a :href="'/' + language" target="_blank">
              <img class="w-[125px] md:block hidden" src="/assets/image/residential/logo singha estate.svg" />
          ...
          <div class="my-auto flex gap-3  relative ml-auto">
            <div>
                <button type="button" class="lg:flex hidden h-full" @click="toggleSubModal">
                    <div class="my-auto">
                        <p class="uppercase text-white leading-tight text-[15px]" :class="singhaFonts">
            ...
            <div class="relative px-2" ref="langRef">
                <button type="button" class="lg:flex hidden h-full" @click="toggleLanguage">
                    <div class="my-auto flex gap-2">
                        <svg class="w-[20px] my-auto" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="uppercase text-white text-[15px] my-auto">{{language}}</p>
                        <svg class="my-auto transition-all duration-500 w-[20px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
