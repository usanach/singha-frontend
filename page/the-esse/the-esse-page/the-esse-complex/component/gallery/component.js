    ...
    template: `
        <section id="gallery" data-section="gallery" class="gallery-component onview bg-[#907F5D] bg-cover bg-center relative font-['IBM_Plex_Sans_Thai']">
            <div class="pt-10 px-0">
                <h2 class="text-[35px] text-center text-white uppercase" :style="{fontFamily:language === 'th' ? '' : 'Gotham'}" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                   {{title[language]}}
                </h2>
                <!-- Category Buttons -->
