const ProjectInformationComponent = defineComponent({
    ...
    <section  class="onview font-['IBM_Plex_Sans_Thai']" :src="{fontClass}" id="project_detail" data-section="project_detail">
      <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-4 relative min-h-[900px] bg-[#F5F5F1] lg:px-0 px-5">
        <!-- Tab Buttons -->
        <div class="bg-[#33617D] bg-cover bg-center py-20 h-full lg:block hidden" :style="{ backgroundImage: 'url(/assets/image/page-srin-rachapuek/description/info.webp)' }">
        ...
        <div class="lg:col-span-3 lg:px-20 pt-10 pb-20">
          <h2 :style="{fontFamily:'DB OnUma'}" class="lg:text-[70px] text-[50px] text-[#2C2C2C] lg:text-left text-center leading-none font-normal">
            {{ title[language] }}
          </h2>
  ...
  `,
    ...
    setup() {
        ...
        const brochureUrl = ref("/assets\/image\/page-srin-rachapuek\/SRIN_SAI_1_E-BROCHURE.pdf");
        const title = ref({
  ...
  `
            ...
            data() {
                return {
                    tabs: [{
                            ...
                            images: [
                                '/assets/image/page-srin-rachapuek/description/floor-plan/banner-01.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-01-floor-01.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-01-floor-02.webp',
                            ],
                            specs: [{
                                ...
                                {
                                    icon: '/assets/icon/floor-plan/rest_room.webp',
                                    alt: '2 พื้นที่พักผ่อนชั้นล่าง​',
                                    text: {
                                        th: '2 พื้นที่พักผ่อนชั้นล่าง​',
                                        en: '2 Downstairs relaxation area​'
                                    }
                                },
                                {
                        ...
                        },
                        {
                            ...
                            images: [
                                '/assets/image/page-srin-rachapuek/description/floor-plan/banner-02.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-02-floor-01.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-02-floor-02.webp',
                            ],
                            specs: [{
                                    icon: '/assets/icon/floor-plan/bedroom.webp',
                                    alt: '5 ห้องนอน',
                        ...
                        },
                        {
                            ...
                            images: [
                                '/assets/image/page-srin-rachapuek/description/floor-plan/banner-03.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-03-floor-01.webp',
                                '/assets/image/page-srin-rachapuek/description/floor-plan/floorplan-03-floor-02.webp',
                            ],
                            specs: [{
                                    icon: '/assets/icon/floor-plan/bedroom.webp',
                                    alt: '4 ห้องนอน',
        ...
        const AmenitiesContent = {
            props: {
                ...
                amenitiesImage: {
                    type: String,
                    default: '/assets/image/page-srin-rachapuek/description/floor-plan/S_RIN_Rachapuek_facilities.webp'
                }
            },
            template: `
        <div>
