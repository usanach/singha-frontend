const ProjectsHighlightComponent = defineComponent({
    ...
    template: `
      <section class="onview" id="project_signature" data-section="project_signature" :class="[fontCss()]">
        <div class="relative">
    ...
    setup() {
        ...
        const projects = ref([
            {
                image: "/assets/image/page-shawn-wongwaen/description/wongwaen-1.png",
                title: {
            ...
            {
                image: "/assets/image/page-shawn-wongwaen/description/wongwaen-2.png",
                title: {
            ...
            {
                image: "/assets/image/page-shawn-wongwaen/description/wongwaen-3.png",
                title: {
            ...
            {
                image: "/assets/image/page-shawn-wongwaen/description/wongwaen-4.png",
                title: {
                    en: "FENGSHUI",
                    th: "FENGSHUI"
                },
