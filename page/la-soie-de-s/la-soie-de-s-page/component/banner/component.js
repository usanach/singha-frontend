const BannerComponent = defineComponent({
  ...
  setup(props) {
    ...
    const defaultSlides = [{
      title: {
        en: "The First Ever Private Estate",
        th: "The First Ever Private Estate"
      },
      theme: {
        text: {
          css: ""
      ...
      image: {
        ...
        s: "/assets\/image\/page-la-soie-de-s\/banner\/banner-m.png",
        logo: "/assets\/image\/page-la-soie-de-s\/logo.png"
      }
    },];
