...
const CraftYourTaleComponent = defineComponent({
    ...
    <section class="craft-your-tale-component relative overflow-hidden">
        ...
        <div class="lg:hidden block">
            <div id="layout-2-m" class="layout-2 absolute inset-0 flex items-center justify-center z-10" class="w-full bg-[url('/assets/image/page-smyth-kaset/craft-yours-tale/img-m.png')] bg-cover bg-center">
            ...
            <div id="layout-1-m" class="layout-1 relative inset-0 flex items-center justify-center z-20">
                <img src="/assets/image/page-smyth-kaset/craft-yours-tale/sm-m.png" alt="" class="w-full">
            </div>
        </div>
    </section>`,
