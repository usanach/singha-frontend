...
<section class="onview font-['IBM_Plex_Sans_Thai']" data-section="360_experience">
  <div class="lg:bg-[#fff] relative">
    <div class="flex flex-col">
      <div class="container py-10">
        <h2 class="text-[35px] text-center text-[#2C2C2C]" :style="{fontFamily:fontClass()}">
          {{ title[language] }}
        </h2>
        ...
        <div class="relative lg:hidden block my-5 z-10" ref="mobileSelectRef">
          <button
            type="button"
            class="project-detail-button-listM bg-[#393936] bg-cover bg-center px-5 text-center w-full lg:py-3 py-2 text-white lg:text-[24px] text-[18px] relative"
            ...
            <div class="absolute left-0 top-0 w-1/5 bg-black/40 h-full lg:flex hidden z-20">
              <div class="m-auto w-full px-4">
                <div class="flex justify-center">
                  <img aria-hidden="true" src="/assets/image/page-siraninn/logo.png" alt="logo" />
                </div>
  ...
  setup() {
    ...
    const scenes = ref([
      {
        id: 'livingRoom',
        label: { en: 'Living Room', th: 'Living Room' },
        url: 'https://my.matterport.com/show/?m=NoWXAMAECEb',
      },
      {
        id: 'bedroom1',
        label: { en: 'Bedroom1', th: 'Bedroom1' },
        url: 'https://my.matterport.com/show/?m=nG79tHwoLaW',
      },
      {
        id: 'bedroom2',
        label: { en: 'Bedroom2', th: 'Bedroom2' },
        url: 'https://my.matterport.com/show/?m=nG79tHwoLaW',
      },
      {
        id: 'bedroom3',
        label: { en: 'Bedroom3', th: 'Bedroom3' },
        url: 'https://my.matterport.com/show/?m=nG79tHwoLaW',
      },
      {
        id: 'bedroom4',
        label: { en: 'Bedroom4', th: 'Bedroom4' },
        url: 'https://my.matterport.com/show/?m=nG79tHwoLaW',
      },
    ]);
    ...
    const fontClass = () => (language.value === 'en' ? 'The Seasons' : 'DB OnUma');
