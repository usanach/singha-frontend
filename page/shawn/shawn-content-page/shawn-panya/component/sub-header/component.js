const SubHeaderComponent = defineComponent({
  ...
  setup() {
    ...
    const logo = ref('/assets/image/page-shawn-panya/banner/shawn-logo.webp');
    ...
    const updateSubHeaderStyle = (progress) => {
      if (subHeader.value && logoRef.value) {
        ...
        if (progress > 0) {
          ...
          logoRef.value.src = '/assets/image/page-shawn-panya/banner/shawn-logo-color.webp';
          ...
          logoRef.value.src = '/assets/image/page-shawn-panya/banner/shawn-logo.webp';
