  ...
  template: `
    ...
    >
      <div class="pt-10 px-0">
        <h2
          class="font-normal text-[35px] text-center text-white uppercase"
          :style="{
            fontFamily: language === 'th'
              ? (galleryFont.th || 'DB OnUma')
              : (galleryFont.en || 'The Seasons'),
            fontSize: language === 'th' ? '40px' : '',
        ...
        <!-- Category Buttons -->
        <div
          class="gallery-controls flex gap-4 mb-6 lg:justify-center justify-evenly lg:px-0 px-5 lg:overflow-x-auto overflow-x-scroll"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-easing="linear"
        >
        ...
        <!-- Desktop Carousel -->
        <div
          v-if="desktopSlides.length"
          class="gallery-content lg:block hidden"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-easing="linear"
        >
          <div class="mx-auto">
            <div class="swiper desktop h-full">
              <div class="swiper-wrapper">
                <div
                  v-for="(slide, n) in desktopSlides"
                  :key="n"
                  class="swiper-slide"
                >
                  <div class="grid grid-cols-4 gap-2 grid-rows-6 h-[600px]">
                    <div
                      ...
                      :class="[
                        item.type === 'image' ? 'p-4' : 'overflow-hidden',
                        i==0 ? 'row-span-6' :
                        i==1 ? 'row-span-3' :
                        i==2 ? 'row-span-4' :
                        i==3 ? 'row-span-6' :
                        i==4 ? 'row-span-3 col-start-2' :
        ...
        <!-- Mobile Carousel -->
        <div
          v-if="mobileSlides.length"
          class="gallery-content lg:hidden block"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-easing="linear"
        >
            ...
            <div class="swiper-wrapper">
              ...
              >
                <img
                  ...
                  :src="item.url"
                  class="m-auto object-cover h-full absolute inset-0"
                />
