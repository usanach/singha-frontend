const BannerComponent = defineComponent({
              ...
              <div class="swiper-slide" v-for="(slide, index) in slides" :key="index">
                ...
                <div class="h-full w-full overflow-hidden bg-cover bg-no-repeat bg-center lg:flex hidden"
                  ...
                  <div class="mx-auto mb-auto mt-24 pt-10 space-y-3 relative">
                    ...
                    <h2 v-if="slide.title" v-html="slide.title[language]" :style="{fontFamily:slide.font[language]}" :style="[language=='th'?'fontSize:35px':'fontSize:35px']" class="pt-5 text-white text-[70px] text-center font-[400]"></h2>
                ...
                <div class="h-full w-full overflow-hidden bg-cover bg-no-repeat bg-center lg:hidden flex"
                  ...
                  <div class="mx-auto mb-auto mt-20 space-y-2 relative">
                    ...
                    <h2 v-if="slide.title" v-html="slide.title[language]" :style="{fontFamily:slide.font[language]}" class="text-white text-[35px] text-center font-[400]"></h2>
                ...
                <div class="flex lg:justify-center justify-center gap-5">
                  ...
                  <div class="flex gap-5">
                    <span class="prev w-[30px]">
                      <img aria-hidden="true" src="/assets/image/residential/Button-Icon.png" alt="prev icon" class="rotate-180">
                    </span>
                    <span class="next w-[30px]">
                      <img aria-hidden="true" src="/assets/image/residential/Button-Icon.png" alt="next icon">
                    </span>
                  </div>
                </div>
              </div>
  ...
  setup(props) {
    ...
    const defaultSlides = [{
      ...
      image: {
        l: "/assets\/image\/page-siraninn\/banner\/banner-1.png",
        s: "/assets\/image\/page-siraninn\/banner\/banner-m.png",
        logo: "/assets\/image\/page-siraninn\/logo.png"
      }
    },];
